                ...
                return (
                  <g key={`link-${idx}`}>
                    <line
                      ...
                      strokeDasharray={
                        link.label === "BELONGS_TO" ? "4" : undefined
                      }
                  ...
                  >
                    ...
                    {node.type === "Post" && (
                      <rect
                        ...
                        rx={2}
                        fill={
                          node.status === "published" ? "#22c55e" : "#3b82f6"
                        }
                        className="pointer-events-none"
                      />
                    )}
            ...
            {selectedNode ? (
              ...
              <div className="flex flex-col items-center justify-center text-center gap-2 flex-1 text-muted-foreground p-4">
                ...
                <p className="text-xs font-medium">
                  Click on any node in the relationship graph to inspect
                  details.
                </p>
              </div>
            )}
