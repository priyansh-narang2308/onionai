      ...
      <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
        <TouchableOpacity
          ...
          style={{
            ...
            borderRadius: 10,
            backgroundColor:
              selectedChannels.length > 0 ? "#f0fdf4" : "#f4f4f5",
          }}
        >
          <Filter
            color={selectedChannels.length > 0 ? "#84cc16" : "#71717a"}
            size={16}
          />
          <Text
            style={{
        ...
        >
          <TouchableOpacity
            ...
            style={{
              ...
              borderRadius: 8,
              backgroundColor:
                viewMode === "calendar" ? "#ffffff" : "transparent",
            }}
          >
            <CalendarDays
              color={viewMode === "calendar" ? "#09090b" : "#71717a"}
              size={18}
            />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <List
              color={viewMode === "list" ? "#09090b" : "#71717a"}
              size={18}
            />
          </TouchableOpacity>
        </View>
