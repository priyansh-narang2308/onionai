...
const PROMPT_TEMPLATES = [
  {
    ...
    icon: Target,
    prompt:
      "Generate 5 creative social media campaign ideas for brand engagement",
  },
  {
    id: "promo",
    label: "Promotional",
...
export function GenerateIdeasPopover({ visible, onClose }: Props) {
  const [step, setStep] = useState<
    "template" | "custom" | "generating" | "results"
  >("template");
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text
                style={{ fontSize: 18, fontWeight: "800", color: "#09090b" }}
              >
                Generate Ideas
              </Text>
            </View>
          ...
          >
            ...
            {step === "custom" && (
              <>
                <Text style={{ fontSize: 14, color: "#71717a" }}>
                  Describe what kind of ideas you need
                </Text>
                <TextInput
                  style={{
                    borderWidth: 1,
                ...
                <View style={{ flexDirection: "row", gap: 10 }}>
                  ...
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      paddingVertical: 12,
                      borderRadius: 14,
                      backgroundColor: customPrompt.trim()
                        ? "#84cc16"
                        : "#e4e4e7",
                    }}
                  >
                    <Sparkles
                      color={customPrompt.trim() ? "#ffffff" : "#a1a1aa"}
                      size={18}
                    />
                    <Text
                      style={{
            ...
            {step === "generating" && (
              <View style={{ alignItems: "center", padding: 40 }}>
                ...
                <Text style={{ fontSize: 15, color: "#71717a", marginTop: 16 }}>
            ...
            {step === "results" && (
              <>
                ...
                >
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleGenerate(customPrompt || PROMPT_TEMPLATES[0].prompt)
                    }
                  >
                    <Text
                      style={{
