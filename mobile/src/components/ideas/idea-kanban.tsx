...
export function IdeaKanban({ ideas, onSelectIdea, onDeleteIdea }: Props) {
  ...
  const getIdeasByGroup = (group: string) =>
    ideas.filter((idea) => (idea.group || "others") === group);
            ...
            >
              <View style={{ gap: 8 }}>
                {groupIdeas.map((idea) => (
                  ...
                  >
                    <Text
                      style={{ fontSize: 13, color: "#09090b", lineHeight: 19 }}
                      numberOfLines={4}
                    >
                      {idea.content}
                    </Text>
                    ...
                    >
                      <TouchableOpacity
                        ...
                        style={{
                          ...
                          paddingVertical: 8,
                          borderRadius: 8,
                          backgroundColor: newIdeaText.trim()
                            ? "#84cc16"
                            : "#e4e4e7",
                          alignItems: "center",
                        }}
                        ...
                        {creating ? (
                          ...
                          <Text
                            style={{
                              fontSize: 12,
                              fontWeight: "700",
                              color: newIdeaText.trim() ? "#ffffff" : "#a1a1aa",
                            }}
                          >
                            Add
                          </Text>
