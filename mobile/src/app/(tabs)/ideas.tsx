...
export default function IdeasTab() {
  ...
  const saveIdeaMutation = useMutation({
    mutationFn: (ideaPayload: {
      ...
      fetchWithAuth(
        "/api/idea",
        { method: "POST", body: JSON.stringify(ideaPayload) },
        getToken,
      ),
    onSuccess: () => {
          ...
          {columns.map((col, index) => {
            ...
            return (
              <TouchableOpacity
                ...
                style={[
                  styles.columnTabButton,
                  isActive && styles.columnTabButtonActive,
                ]}
              >
                <Text
                  style={[
                ...
                <View
                  style={[
                    styles.columnCountBadge,
                    isActive && styles.columnCountBadgeActive,
                  ]}
                >
                  <Text
                    style={[
                      styles.columnCountText,
                      isActive && styles.columnCountTextActive,
                    ]}
                  >
                    {col.ideas?.length || 0}
                  </Text>
        ...
        >
          {activeColumn && activeColumn.ideas?.length === 0 ? (
            <View style={styles.emptyFeedCard}>
              ...
              <Text style={styles.emptyFeedHeading}>
                No ideas in {activeColumn.title}
              </Text>
                  ...
                  <View style={styles.ideaImagesRow}>
                    ...
                    {idea.images.length > 3 && (
                      <View style={styles.ideaMoreImages}>
                        <Text style={styles.ideaMoreImagesText}>
                          +{idea.images.length - 3}
                        </Text>
                      </View>
                    )}
          ...
          <View style={styles.modalCard}>
            ...
            <View style={styles.infoBox}>
              ...
              <Text style={styles.infoBoxText}>
                Describe your business and audience to generate 3 content ideas
                using AI.
              </Text>
            </View>
            <View style={styles.formGroup}>
            ...
            >
              {aiGenerateMutation.isPending ? (
                ...
                <>
                  ...
                  <Text style={styles.aiGenerateBtnText}>Generate Ideas</Text>
                </>
              )}
            </TouchableOpacity>
          </View>
